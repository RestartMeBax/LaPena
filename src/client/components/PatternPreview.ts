...
export function renderPatternPreview(
  ...
  if (pattern.imageUrl) {
    return html`<img
      ...
      alt="Skin preview"
      class="w-full h-full object-cover object-center scale-[1.22] pointer-events-none"
      draggable="false"
    />`;
  }
  return html`<img
    ...
    alt="Pattern preview"
    class="w-full h-full object-contain object-center [image-rendering:pixelated] pointer-events-none"
    draggable="false"
  />`;
}
