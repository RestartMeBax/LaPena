...
export type LeaderboardTab = "players" | "mostWins" | "clans";
...
export class LeaderboardTabs extends LitElement {
  ...
  @state()
  private mostWinsClass = this.getTabClass(this.activeTab === "mostWins");
  @state()
  ...
  private handleTabChange(tab: LeaderboardTab) {
    ...
    this.mostWinsClass = this.getTabClass(tab === "mostWins");
    ...
    return html`
      ...
      >
        ...
        <button
          type="button"
          role="tab"
          class="${this.mostWinsClass}"
          @click=${() => this.handleTabChange("mostWins")}
          id="most-win-leaderboard-tab"
          aria-selected=${this.activeTab === "mostWins"}
        >
          MOST WINS
        </button>
        <button
