...
function syncHashedPublicAssets() {
  return {
    ...
    closeBundle() {
      ...
      createHashedPublicAssetFiles(resourcesDir, outDir, manifest);
      copyRootPublicFiles(resourcesDir, outDir);
      writePublicAssetManifestModule(outDir, manifest);
    },
  };
}
...
export default defineConfig(({ mode }) => {
  ...
  const htmlAssetData = {
    ...
    desktopLogoImageUrl: buildAssetUrl("images/Robuste.webp", assetManifest),
    mobileLogoImageUrl: buildAssetUrl("images/RobusteLogoDark.svg", assetManifest),
  };
