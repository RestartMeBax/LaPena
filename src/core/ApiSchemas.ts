...
export const MostWinLeaderboardEntrySchema = z.object({
  rank: z.number(),
  playerId: z.string(),
  username: LeaderboardUsernameSchema,
  clanTag: LeaderboardClanTagSchema.nullable().optional(),
...
export type MostWinLeaderboardEntry = z.infer<
  typeof MostWinLeaderboardEntrySchema
>;

export const MostWinLeaderboardResponseSchema = z.object({
  players: MostWinLeaderboardEntrySchema.array(),
});
export type MostWinLeaderboardResponse = z.infer<
  typeof MostWinLeaderboardResponseSchema
>;
