...
export class LeaderboardModal extends BaseModal {
  @state() private activeTab: "players" | "mostWins" | "clans" = "players";
  @state()
  ...
  private loadActiveTabData() {
    ...
    const run = async () => {
      ...
      if (this.activeTab === "players" || this.activeTab === "mostWins") {
  ...
  private handleTabChange(tab: "clans" | "players" | "mostWins") {
    this.activeTab = tab;
    this.loadActiveTabData();
  }
      ...
      <div class="${this.modalContainerClass}">
        ...
        <div class="flex-1 flex flex-col min-h-0">
          <leaderboard-tabs
            ...
            @tab-change=${(event: CustomEvent<"players" | "mostWins" | "clans">) =>
              this.handleTabChange(event.detail)}
          ></leaderboard-tabs>
          <div class="flex-1 min-h-0">
            <leaderboard-player-list
              .mode=${this.activeTab === "mostWins" ? "mostWins" : "players"}
              class=${this.activeTab === "players" || this.activeTab === "mostWins"
                ? "h-full"
                : "hidden"}
            ></leaderboard-player-list>
